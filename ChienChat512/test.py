...
while True:
    ...
    ret, frame = cap.read()
    frame_resized = cv2.resize(frame,(512,512)) # resize frame for prediction
    ...
    # (1, 3, 300, 300)
    blob = cv2.dnn.blobFromImage(frame_resized, 0.007843, (512, 512), (127.5, 127.5, 127.5), False)
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > 0.1: #args.thr: # Filter prediction 
            ...
            heightFactor = frame.shape[0]/512.0  
            widthFactor = frame.shape[1]/512.0 
